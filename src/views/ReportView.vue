          ...
          <tr v-for="item in reData" class="border-bottom text-center">
            ...
            <td>
              <div class="form-check form-switch">
                <input
                  @click="updateReport(item.report_id)"
                  class="form-check-input"
                  role="switch"
                  type="checkbox"
                  :name="item.report_id"
                  :id="item.report_id"
                  :checked="item.report_state == 1"
                />
            ...
            <td>
              <input
                type="checkbox"
                @click="checkReport(item.report_id)"
                :name="item.report_id"
                :id="item.report_id"
