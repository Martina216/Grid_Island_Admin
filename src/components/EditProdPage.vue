        ...
        <div class="wrapper">
          <div class="text">
            <div class="title">
              ...
              <input v-model="editedData.prod_name" type="text" name="news_title" id="newsTitle" class="form-check-input rounded border border-1 border-gray" placeholder="請輸入商品名稱">
            </div>
            <div class="brief">
              <label for="prodBrief"><span>商品簡介</span></label>
                <textarea name="prod_brief" id="prodBrief" cols="10" rows="5" class=" rounded border border-1 border-gray" placeholder="請輸入商品短語簡介" ></textarea>
            </div>
            ...
            <div class="content">
              ...
              <textarea v-model="editedData.prod_intro" name="prod_intro" id="prodIntro" cols="10" rows="12" class=" rounded border border-1 border-gray" placeholder="請輸入商品介紹與遊玩方法" ></textarea>
            </div>
            <div class="device">
              <label for="prodDesc"><span>規格資訊</span></label>
                <textarea v-model="editedData.prod_desc" name="prod_desc" id="prodDesc" cols="10" rows="10" class=" rounded border border-1 border-gray" placeholder="請輸入商品規格資訊" ></textarea>
            </div>
            <div class="date">
              <label for="newsDate"><span>發佈時間</span></label>
              <input v-model="editedData.prod_date" type="datetime-local" name="news_date" id="newsDate" class="form-check-input rounded border border-1 border-gray">
            </div>
          </div>
          <div class="imgContent">
            ...
            <div class="priceArea">
              <div class="price">
                ...
                <input v-model="editedData.prod_price" type="number" name="prod_price" id="prodPrice" min="300" class="form-check-input rounded border border-1 border-gray" placeholder="輸入價格">
              </div>
              <div class="DisPrice">
                <label for="prodDiscountPrice"><span>特價</span></label>
                <input v-model="editedData.prod_discount_price" type="number" name="prod_discount_price" id="prodDiscountPrice" min="300"
...
export default {
  ...
  methods:{
    ...
    try {
      ...
      formData.append('news_date', new Date(this.editedData.news_date).toISOString());
